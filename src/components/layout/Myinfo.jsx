  ...
  return (
    <div>
      <>
        ...
        >
          <Modal.Body className="bg-pr border border-white px-5 py-4 overflow-hidden h-full">
            <button onClick={() => setShow(false)} className="text-sc text-2xl">
            ...
            <div className="mt-3 grid grid-cols-1 lg:grid-cols-2 gap-4 text-white">
                ...
                <div className="mt-2 gap-y-3">
                  <div>
                    <p className="font-light my-2">
                      Name: <strong className="text-sc">Sohanur Rahman</strong>
                    </p>
                    <p className="font-light my-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                <div className="border border-white border-opacity-10 p-3 flex items-center justify-center flex-col">
                ...
                <div className="border border-white border-opacity-5 p-3 flex items-center justify-center flex-col">
              ...
              <div className="grid mt-5 grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                ...
                <div className="mb-3 pl-7 border-l border-white w-100 h-100 relative">
                  ...
                  <h1 className="text-xl text-white">
                    ...
                    <span className="text-sc"> Puthia PN High School</span>
                  </h1>
                  <p className="text-xs font-thin mt-2 text-white">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    Eligendi aliquam deleniti accusamus eaque. Laboriosam quod,
